...
public class MethodsExcercises {
    ...
    public static void main(String[] args){
        MethodsExcercises  methodsExcercises = new MethodsExcercises(); // Elvina:created a new oblect
        ...
        System.out.println("the minimum of numbers "+a+" "+b+" and  "+c+" is "+ methodsExcercises.findSmallest(a, b, c)); // Elvina:added that object
        ...
        System.out.println("the lone sum of numbers "+a+" "+b+" and  "+c+" is "+ methodsExcercises.loneSum(a, b, c));// Elvina: added oblect
    ...
    //Exc1: Write a Java method to find the smallest number among three numbers
    public  int findSmallest(int a, int b, int c){ // Elvina:deleted static
    ...
    public  int loneSum(int a, int b, int c){// Elvina: deleted static
        if (a == b && a == c) {
            a = 0;
            b = 0;
            c = 0;
